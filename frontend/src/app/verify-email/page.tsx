...
function VerifyEmailForm() {
  ...
  return (
    <div className="flex flex-col flex-grow justify-center bg-slate-950 py-12 px-4 text-slate-100">
      <Container size="sm">
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl text-center space-y-6">
          {statusState === "loading" && (
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <Link
                  ...
                  className="px-6 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm transition-colors cursor-pointer inline-block"
                >
          ...
          {statusState === "error" && (
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-slate-800 space-y-2">
                <Link
                  href="/login"
                  className="w-full py-2.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-white font-semibold text-sm transition-colors cursor-pointer inline-block"
                >
                  Back to Login
                </Link>
              </div>
