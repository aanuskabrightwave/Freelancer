    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-10 px-4 md:px-8 font-sans">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl backdrop-blur-xl">
          <h1 className="text-xl md:text-2xl font-black text-white">My Client Bookings</h1>
          <p className="text-slate-400 text-xs mt-1">Track status, execution timelines, and manage rescheduling overrides.</p>
        </div>
          ...
          {filteredBookings.map((booking) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                <div>
                  <h4 className="text-slate-500 font-semibold mb-1 uppercase tracking-wider text-[10px]">Service / Project</h4>
                ...
                <div>
                  <h4 className="text-slate-500 font-semibold mb-1 uppercase tracking-wider text-[10px]">Execution Date</h4>
