...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Inspect watermarked draft color grades and exports, and submit timestamped revision notes on the timeline."
  },
  {
    num: "05",
    title: "APPROVE THE MASTERS",
    desc: "Approve the final project when it meets your standards, releasing the funds safely held in platform escrow."
  },
  {
    num: "06",
    title: "SECURE DELIVERY",
    desc: "Instantly unlock the high-resolution master file downloads (like ProRes exports) and close the booking."
  }
];
              ...
              >
                <div className="flex items-center gap-3">
                  <span className={`text-xs font-black px-2.5 py-1 rounded ${
                    activeStep === idx ? "bg-primary text-white" : "bg-white/10 text-slate-400"
                  }`}>
                    {step.num}
                  </span>
